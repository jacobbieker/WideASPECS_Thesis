...
[FRIDAY: Get Prev. Work written for Survey and Clustering. End of Day:Clean up Intro more, Add plots for clustering/nicer ones for Survey. Send to Mom and Laura.]

[SATURDAY: Write better abstract, clean up intro more/Cite everything. Add more to Future Work based off past emails. Make last remaining Tables. Fill out Discussion on Survey, and Clustering based off current results. Fix COSMIC Volume in Matching. Add all plots in Appendix.]. 
